...
public interface DaoInterface {
	...
	/**
	 * Returns a list of BaseEntity sub-type objects, that match the name or title 
	 * given by the {@link param}}
	 ...
	 */
	<X extends BaseEntity> List<X> getByName(String param);
	 ...
	 * @param id - the id that represents the object to search for
	 * @return - an actual object that extends the BaseEntity
	 */
	<X extends BaseEntity> X getById(String id);
